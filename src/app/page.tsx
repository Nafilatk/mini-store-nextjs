      ...
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-42 px-16 bg-white dark:bg-black sm:items-start">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white">
          ...
          <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
            ...
            <a
              className="flex h-12 w-full items-center justify-center rounded-full border border-solid  px-5 transition-colors hover:border-transparent hover:bg-black dark:border-white/[.145] dark:hover:bg-[#1a1a1a] md:w-[158px]"
              href="/"
              target="_blank"
              rel="noopener noreferrer"
            >
